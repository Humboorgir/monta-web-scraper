...
const PAGE_SIZE = 5;
const ITERATIONS = 132; // 56 * 5 = 280 offsets attempted
const DELAY_MS = 3000; // 3s delay
const HEADERS = {
  accept: "*/*",
  "accept-language": "en-US,en;q=0.9",
  authorization:
    "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjp7ImlkIjozMzMyMzg4LCJuYW1lIjoi2KfbjNmE24zYpyDZgdi22YQg2KfZhNmE2YfbjCIsInR5cGVJZCI6MSwic3ViVHlwZUlkIjoxLCJhY2NvdW50c0NvdW50IjoxfSwiaWF0IjoxNzU2OTIxMDU0LCJleHAiOjE3NTcwMDc0NTQsImp0aSI6ImVjZjFiZTg1LTNhZDktNGM1MS1iMDAyLWIxYjk2MGJlMDBjYSJ9.g9FDgh2sW2iKNnV4NAyozoa7-moqZIvPAiLKIUOmQ-I",
