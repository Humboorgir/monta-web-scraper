...
const PAGE_SIZE = 5;
const ITERATIONS = 56; // 56 * 5 = 280 offsets attempted
const DELAY_MS = 3000; // 3s delay
const HEADERS = {
  accept: "*/*",
  "accept-language": "en-US,en;q=0.9",
  authorization:
    "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjp7ImlkIjozMzMyMzg4LCJuYW1lIjoi2KfbjNmE24zYpyDZgdi22YQg2KfZhNmE2YfbjCIsInR5cGVJZCI6MSwic3ViVHlwZUlkIjoxLCJhY2NvdW50c0NvdW50IjoxfSwiaWF0IjoxNzU3MDA4NjA4LCJleHAiOjE3NTcwOTUwMDgsImp0aSI6IjFlMWJmNzQ4LTBmYTgtNDI1Yi1iZDk2LWMwOGNmYWFhY2FkYiJ9.uYsVhj0tNZuC8olZeBWJ1zcW87xFcotspG0rrRlrdSQ",
